...
export function normalizeComplaintClassifierOutput(value, rawText) {
  ...
  if (!Array.isArray(value.reason_codes) || value.reason_codes.length > 8) {
    throw invalidOutput("reason_codes must be an array with at most 8 items");
  }
  ...
  if (reasonCodes.length === 0) throw invalidOutput("At least one reason_code is required");
