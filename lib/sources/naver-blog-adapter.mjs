...
export const NAVER_BLOG_ADAPTER_VERSION = "naver-api-hub-blog-search-v3-origin-contract";
...
export function normalizeNaverBlogItem(item) {
  ...
  const origin = classifySourceOrigin(canonicalUrl);
  ...
  return {
    ...
    source_origin_classifier_version: origin.classifier_version,
    source_metadata: {
      provider: "naver_api_hub",
      resource: "blog_search",
