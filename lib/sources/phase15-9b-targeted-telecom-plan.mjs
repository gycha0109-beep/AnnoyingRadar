...
export const PHASE15_9B_SEED_CONTENT_SHA256 = PHASE15_9A_PRIMARY_SEED.source_content_sha256;
    ...
    return {
      ...
      input: {
        ...
        request_metadata: {
          ...
          protected_seed_identity_sha256: PHASE15_9B_SEED_IDENTITY_SHA256,
        },
      },
    };
  });
