...
export async function assertCandidateOwner(
  candidateId,
  userId,
  serviceClient,
  columns = "*",
  ...
  if (error) {
    ...
    throw new ApiError(
      500,
      "candidate_owner_check_failed",
      "Failed to verify Problem Candidate owner",
    );
  }

  if (!data) {
    throw new ApiError(404, "candidate_not_found", "Problem Candidate not found");
  }
